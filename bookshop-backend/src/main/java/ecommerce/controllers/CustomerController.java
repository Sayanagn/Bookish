...
public class CustomerController {
	 ...
	 * @GetMapping
	 * 
	 * @ApiOperation(value="List all customers",response=Iterable.class) public
	 * ResponseEntity<?> findAllCustomers() { List<Customer> result =
	 * customerService.allCustomers(); return Response.success(result); }
	 */
	...
	/*
	 * @PutMapping("{id}") public ResponseEntity<?> updateProfile(@RequestBody
	 * Customer cust,@PathVariable("id") int id) {
	 * customerService.updateProfile(cust); return Response.status(HttpStatus.OK); }
	 */
